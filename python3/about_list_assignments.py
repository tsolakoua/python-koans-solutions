...
class AboutListAssignments(Koan):
    ...
    def test_parallel_assignments(self):
        first_name, last_name = ["John", "Smith"] # interesting
        self.assertEqual("John", first_name)
        self.assertEqual("Smith", last_name)

    def test_parallel_assignments_with_extra_values(self): # interesting
    ...
    def test_parallel_assignments_with_sublists(self): # interesting
